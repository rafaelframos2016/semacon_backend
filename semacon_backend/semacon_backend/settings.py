...
if DEBUG:
    ...
    ALLOWED_HOSTS = ["68.183.63.19"] #os.environ.get("DJANGO_ALLOWED_HOSTS").split(" ")
...
ROOT_URLCONF = 'semacon_backend.urls'
...
WSGI_APPLICATION = 'semacon_backend.wsgi.application'
ASGI_APPLICATION = 'semacon_backend.asgi.application'
